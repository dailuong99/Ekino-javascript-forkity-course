...
const displayMovements = function (movements, sort = false) {
  ...
  movs.forEach((mov, i) => {
    ...
    `;
    containerMovements.insertAdjacentHTML('afterbegin', htmlTeamplate);
  });
};
...
const daiarr = [1, 2, -3, 3, -4, -6, 7, 8];
// const balance = daiarr.reduce(function (acc, curr, i, arr) {
//   console.log(`Iteration ${i}: ${acc}`)
//   return curr + acc;
// },-1);
// const balance = daiarr.reduce((acc, cur) => acc + cur, 0);
...
// console.log(convertTitleCase('luong tan a dai'));
...
console.log(
  `Sarah's dog is eating too ${dogs.curFood > dogs.recFood ? 'much' : 'little'}`
);
...
console.log(`${ownersEatTooLittle.join(' and ')} dogs eat too title!`);
